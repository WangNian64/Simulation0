...
public class LiftTransfer1 : MonoBehaviour {
    ...
    public static void CreateChain(GameObject Chain,ref LiftTransferParameter LTP)
    {
        ...
        GameObject obj0 = Resources.Load<GameObject>(GlobalVariable.RootName+"/ChainEquipment/UnitChain");//加载链条关节小构件模型
    ...
    public static void CreateGearChain(GameObject GearChain, ref LiftTransferParameter LTP)
    {
        ...
        //添加齿轮信息
        GameObject obj = Resources.Load<GameObject>(GlobalVariable.RootName+"/ChainEquipment/Gear0");
        Vector3 obj_size = new Vector3();//齿轮模型尺寸
        MyClass.MeshSize(obj, ref obj_size);
    ...
    public static void CreateLiftChain(GameObject LiftChain, ref LiftTransferParameter LTP)
    {
        ...
        GameObject obj1 = Resources.Load<GameObject>(GlobalVariable.RootName+"/ChainEquipment/Board");//加载边板构件
    ...
    public static void CreateFrame(GameObject Frame, ref LiftTransferParameter LTP)
    {
        ...
        GameObject obj = Resources.Load<GameObject>(GlobalVariable.RootName+"/ChainEquipment/Board");
        //创建框架1
    ...
    public static void CreateTransPort(GameObject RollerPart, GameObject LiftPart, ref LiftTransferParameter LTP)
    {
        ...
        //创建滚筒
        GameObject obj0 = Resources.Load<GameObject>(GlobalVariable.RootName+"/ChainEquipment/Roller");
