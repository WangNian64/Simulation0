...
public class RollerConveyor : MonoBehaviour
{
    ...
    public static void Create_RollerPart(RollerConveyor_Parameter RCP, GameObject RollerPart)
    {
        ...
        GameObject Roller = Resources.Load(GlobalVariable.RootName+"/RollerConveyor/RollerX") as GameObject;
    ...
    public static void Create_SideBoard(RollerConveyor_Parameter RCP, GameObject SideBoard)
    {
        ...
        GameObject SB1 = Resources.Load(GlobalVariable.RootName+"/RollerConveyor/Sideboard1") as GameObject;//加载边板1的组件
    ...
    public static void Create_SupportFoot(RollerConveyor_Parameter RCP, GameObject SupportFoot)
    {
        ...
        GameObject SF = Resources.Load(GlobalVariable.RootName+"/RollerConveyor/SupportFoot") as GameObject;//加载构件
    ...
    public static void Create_BeltPart(RollerConveyor_Parameter RCP, GameObject BeltPart)
    {
        ...
        //增加皮带部分
        GameObject Belt = Resources.Load(GlobalVariable.RootName+"/RollerConveyor/Belt") as GameObject;
