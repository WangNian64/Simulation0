...
public class Piler1 : MonoBehaviour
{
    ...
    public static void CreatePathway(PilerParameter PP,GameObject Pathway)
    {
        ...
        //定制上轨道
        GameObject obj1 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/上轨道");
        ...
        //定制下轨道
        GameObject obj2 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/下轨道");
    ...
    public static void CreateBodyPart(PilerParameter PP, GameObject BodyPart)
    {
        ...
        // 上轨道信息
        GameObject obj0 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/上轨道");
        float Scale0 = obj0.transform.localScale.x;
        Vector3 Size0 = obj0.GetComponent<MeshFilter>().sharedMesh.bounds.size;
        // 加载关键构件
        GameObject obj3 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/body1");//上滚轴
        GameObject obj4 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/body2");//下滚轴
        GameObject obj5 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/body0");//竖直机身
        GameObject obj6 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/ElectricBox");//电箱部分
        //上滚轴、下滚轴信息
        ...
        //增加上下移动部分
        GameObject obj7 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/UpPart");//上下移动部分
    ...
    public static void CreatePiler(PilerParameter PP, GameObject OBJ) {
        ...
        // 主体机身部分
        GameObject obj = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/body2");
    ...
    public static void CreateUpPart(GameObject OBJ) {
        // 上下移动部分
        GameObject obj1 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/UpPart");
        ...
        // 叉手部分
        GameObject obj2 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Piler/叉手");
