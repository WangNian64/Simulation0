...
namespace BlackBox.WareHouse.ControlUnit.UIControl
{
    public class BinsPanel : MonoBehaviour
    {
        ...
        {
            GameObject StorageStateInterface0 = (GameObject)Resources.Load(Varibles.GlobalVariable.RootName + "/Simulation/StorageStateInterface0");
            ...
            //GameObject ScrollBar = ShelfPanel3.transform.Find("Scrollbar").gameObject;
            ...
            //添加Bin
            GameObject Bin = (GameObject)Resources.Load(Varibles.GlobalVariable.RootName + "/Simulation/Bin");
            //Bin.GetComponent<Image>().color = new ;
            ...
            #endregion
            //保存为预制体
            Tools.MyClass.CreatePrefab(StorageStateInterface, "Assets/Resources/" + Varibles.GlobalVariable.RootName + "/Simulation/" + StorageStateInterface.name);
        }

        public static void Ajustment2(int ShelfNum, int FloorNum, int ColumnNum)
        {
            GameObject CreateInterface0 = (GameObject)Resources.Load(Varibles.GlobalVariable.RootName + "/Simulation/CreateInterface0");
            ...
            //保存为预制体
            Tools.MyClass.CreatePrefab(CreateInterface0, "Assets/Resources/" + Varibles.GlobalVariable.RootName + "/Simulation/" + CreateInterface0.name);
        }
    }
}
