...
public class BinsPanel : MonoBehaviour
{
    ...
    {
        GameObject StorageStateInterface0 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Simulation/StorageStateInterface0");
        ...
        //添加Bin
        GameObject Bin = (GameObject)Resources.Load(GlobalVariable.RootName+"/Simulation/Bin");
        ...
        #endregion
        //保存为预制体
        MyClass.CreatePrefab(StorageStateInterface, "Assets/Resources/"+GlobalVariable.RootName+"/Simulation/" + StorageStateInterface.name);
    }

    public static void Ajustment2(int ShelfNum, int FloorNum, int ColumnNum)
    {
        GameObject CreateInterface0 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Simulation/CreateInterface0");
        ...
        //保存为预制体
        MyClass.CreatePrefab(CreateInterface0, "Assets/Resources/"+ GlobalVariable.RootName+"/Simulation/" + CreateInterface0.name);
    }
}
