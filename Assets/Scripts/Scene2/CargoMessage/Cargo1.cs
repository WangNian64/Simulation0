...
public class Cargo1 : MonoBehaviour
{
    ...
    {
        GameObject obj = (GameObject)Resources.Load(GlobalVariable.RootName+"/Cargo/Cube1");//创建底座
    ...
    {
        GameObject obj2 = (GameObject)Resources.Load(GlobalVariable.RootName+"/Cargo/Cube2");//创建货物
        //货物箱
