...
public class WareHouseScene1 : EditorWindow
{
    ...
    private void OnGUI()
    {
        ...
        ParaName = EditorGUILayout.TextField("参数表名：", ParaName);
        ...
        GlobalVariable.RootName = RootName;
        path1 = @"Assets/Resources/" + RootName + "/" + ParaName;
        path2 = "Assets/Resources/" + RootName + "/Simulation/";
    ...
    public void Create_Scene(ParametersList1 PL, PositionsList POL, string Path)
    {
        ...
        //添加地面
        //GameObject obj = (GameObject)Resources.Load("Warehouse_One_Material/Dimian");
