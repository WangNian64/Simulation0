...
namespace BlackBox.WareHouse.CreateUnit.CreateModel
{
    public struct CargoInfo
    {
        ...
        public int Num;//货物件数
        public Varibles.PositionInfo PositionInfo;//所要存储所在仓位信息
    ...
    public class Cargo1 : MonoBehaviour
    {
        ...
        {
            GameObject obj = (GameObject)Resources.Load(Varibles.GlobalVariable.RootName + "/Cargo/Cube1");//创建底座
        ...
        {
            GameObject obj2 = (GameObject)Resources.Load(Varibles.GlobalVariable.RootName + "/Cargo/Cube2");//创建货物
                                                                                                   //货物箱
